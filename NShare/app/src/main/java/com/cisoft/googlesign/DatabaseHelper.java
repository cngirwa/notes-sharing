 ...
 * Imetengezwa na Canon C. Ngirwa tarehe 11/13/2020.
 * Haki zote zimehifadhiwa. Ci-Software 2020
 */
public class DatabaseHelper extends SQLiteOpenHelper {

    //database name
    public static final String DATABASE_NAME = "nsCngirwa";
    //database version
    ...
    public ArrayList<NoteModel> getNotes() {
        ...
        // select all query
        String select_query = "SELECT *FROM " + TABLE_NAME + " ORDER BY ID DESC";
